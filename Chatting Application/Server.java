...
public class Server extends JFrame {
    ...
    public Server() {
        ...
        JLabel nameLabel = new JLabel("Rohit Sharma");
    ...
    private void addMessage(String message, boolean isServer) {
        ...
        JPanel bubblePanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                Graphics2D g2 = (Graphics2D) g.create();
                g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
                g2.setColor(isServer ? MESSAGE_BG : INPUT_BG);
        ...
        wrapperPanel.add(bubblePanel, isServer ? BorderLayout.EAST : BorderLayout.WEST);
    ...
    private void startServer() {
        try {
            ...
            addMessage("Server started. Waiting for Virat to connect...", true);
            
            clientSocket = serverSocket.accept();
            addMessage("Virat connected!", true);
